<template>
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        <div class="main-left col-span-1">
            <div class="p-4 bg-white border border-gray-200 text-center rounded-lg dark:bg-neutral-900 dark:border-gray-950 dark:text-white">
        ...
        <div class="main-center col-span-2 space-y-4">
            ...
            <div 
                class="p-4 bg-white border border-gray-200 rounded-lg grid grid-cols-2 gap-4 dark:bg-neutral-900 dark:border-gray-950 dark:text-white"
                v-if="friends.length"
            >
                <div 
                    class="p-4 text-center bg-gray-100 rounded-lg dark:bg-neutral-800 dark:border-gray-950"
